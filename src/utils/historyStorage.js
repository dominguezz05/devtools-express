 ...
 * @param {string} toolName - El nombre de la herramienta (ej. 'code-minifier').
 * @param {string} entry - La entrada a guardar.
 */
export function saveToHistory(toolName, entry) {
  ...
  try {
    ...
    // Añade la nueva entrada al principio, filtra duplicados y limita el tamaño.
